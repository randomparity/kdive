...
from kdive.providers.core import libvirt_xml as libvirt_xml_contract
from kdive.providers.core.libvirt_xml import KDIVE_METADATA_NS, parse_metadata_system_id
