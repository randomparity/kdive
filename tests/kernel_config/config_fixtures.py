...
``KernelConfig.builtin`` deliberately does not default (#1860): a default of empty would
reinterpret every pre-existing positional fixture as a wholly modular kernel and fail an
