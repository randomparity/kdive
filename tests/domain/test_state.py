...
def test_illegal_transition_message_names_the_lifecycle_and_both_states() -> None:
    # The message must identify which lifecycle and which edge was refused, so an operator
    # can locate the offending transition rather than read a generic "NoneType" message.
