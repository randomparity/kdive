...
def test_investigation_build_migration_tail_is_unique_and_monotonic() -> None:
    ...
    assert [(migration.version, migration.filename) for migration in migrations[-43:]] == [
        ...
        ("0124", "0124_external_boot_activation_binding.sql"),
        ...
        ("0130", "0130_external_boot_cmdline_failure_diagnostics.sql"),
        ("0131", "0131_remote_module_volume_reap_job_kind.sql"),
        ...
        ("0144", "0144_external_boot_recovery_orphan_authority.sql"),
    ]
...
_SEED_SHAPES = {
    ...
    "large": (4, 8192, 40),
    "max": (8, 16384, 80),
    "debug": (4, 8192, 60),  # migration 0061 (#985, ADR-0312)
}
