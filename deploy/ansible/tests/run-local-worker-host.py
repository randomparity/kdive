...
require(len(actual_tasks) == 311, f"runner listed {len(actual_tasks)} baseline tasks, expected 311")
...
print("ok runner: 311 ordered task names and tags match the updated baseline")
