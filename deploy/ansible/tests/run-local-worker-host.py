...
require(len(actual_tasks) == 309, f"runner listed {len(actual_tasks)} baseline tasks, expected 309")
...
print("ok runner: 309 ordered task names and tags match the updated baseline")
