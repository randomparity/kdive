...
require(len(actual_tasks) == 310, f"runner listed {len(actual_tasks)} baseline tasks, expected 310")
...
print("ok runner: 310 ordered task names and tags match the updated baseline")
