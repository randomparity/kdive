...
-- exactly two persisted values ('running', 'succeeded'), but 0001_init.sql left
...
-- existing rows cannot fail. The CHECK mirrors PERSISTED_RUN_STEP_STATES exactly; the named
-- constraint is pinned to the shared vocabulary by test_migrate.py (plus a dedicated
