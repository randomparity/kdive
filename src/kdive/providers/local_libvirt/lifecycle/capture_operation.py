...
class LocalCaptureExecutor:
    """Run local-libvirt capture primitives inside the single-process child boundary."""
        ...
        try:
            ...
            if len(data) > request.max_bytes:
                raise CategorizedError(
                    "local capture result exceeded its request byte bound",
