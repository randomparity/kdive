...
remote (``shared.debug_common.gdbmi.policy.debuginfo`` — ``stage_and_attach``). This module keeps
only local-libvirt's configured ``default_attach_seam``: it stages the Run's vmlinux via the shared
