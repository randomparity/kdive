...
# not just the submitted URL string (ADR-0158): no redirect-follow off the allowlisted host,
...
def make_checkout(
    ...
    Args:
        ...
        allowlist: Remotes the local git-clone lane may clone (ADR-0158); empty disables it.
    """
...
def real_checkout(
    ...
    *,
    ...
    allowlisted remote (ADR-0158), a bare string mirrors the warm tree.
    """
...
def clone_tree(
    ...
    *,
    ...
    """Clone ``source.remote`` at ``source.ref`` into a clean ``workspace`` (ADR-0158).
