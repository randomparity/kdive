...
**Spec:** `docs/design/local-git-build-lane.md` · **ADR:** `docs/adr/0162-local-git-build-lane.md`
...
- ADR number is **0162**; already created. Do not pick a new one.
...
**CI gates this touches (all run individually in CI):** `config-docs-check`, `resources-docs-check`, `env-docs-check` (satisfied by the registry entry from Task 1), `adr-status-check` (ADR-0162 is Accepted + the README row matches).
