...
- **ADR:** [`../../adr/0158-buildhost-source-kind-discovery.md`](../../adr/0158-buildhost-source-kind-discovery.md)
- **Issue:** #536
...
- Run `python3 scripts/check_adr_status.py` (ADR index in sync — already added 0158).
