...
- **ADR:** [../../adr/0157-guest-agent-deterministic-failure-classification.md](../../adr/0157-guest-agent-deterministic-failure-classification.md)
...
1. Add a module-level constant near the other module constants (after `_DEFAULT_POLL_S`):
   ...
   ```
   Add a short comment citing ADR-0157 and naming the "agent not configured / permission
