...
The SUSE family uses the existing modular socket list and monolithic-unit masking path, shared
with RedHat. Its package list installs the QEMU daemon bundle, proxy, client, host tools, and Python
