...
| [0157](0157-create-time-build-host-source-check.md) | Validate build-host ↔ kernel-source compatibility at `runs.create` via a shared `check_source_kind_compatibility` helper; keep the build-time check as a backstop. | Proposed |
