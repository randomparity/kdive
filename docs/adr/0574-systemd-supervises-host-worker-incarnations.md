# 0574 — Systemd retains host worker incarnations
...
receive the lifecycle-witness database authority ([ADR-0536](0536-enforce-worker-fence-authority-boundaries.md)).
