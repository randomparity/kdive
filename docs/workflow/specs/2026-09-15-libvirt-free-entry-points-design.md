...
[ADR-0659](../../adr/0659-libvirt-free-entry-points-opt-out-of-resolution.md) keeps fail-closed
...
- ADR-0659 prose — Mode: `task-test-not-applicable`; no contract beyond the records gate.
