...
- Success 3 — `test_a_preset_is_honoured_silently_without_a_valid_contract`, parametrized over an
  absent and an allowlist-refused contract, asserting exit 0 and empty stderr; red without either
  half of the loader-failure handling.
