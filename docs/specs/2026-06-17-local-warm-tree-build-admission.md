...
is the **worker BUILD job entry**. See ADR-0161 "Considered & rejected" for the full
...
- No kernel bytes are committed and no auto-download is added (ADR-0161 rationale).
