...
SSH. See [ADR-0365](../adr/0365-race-debugging-out-of-band.md) for that decision.
...
- [ADR-0365](../adr/0365-race-debugging-out-of-band.md) — resolving #986 as docs, not a code mode.
