...
scripts/generate/gen_tool_reference.py. Run via `just config-docs` / `just config-docs-check`.
"""
...
_HEADER = (
    "<!-- generated by scripts/generate/gen_config_reference.py; do not edit. "
    "Regenerate: just config-docs -->"
)
_OUT = Path(__file__).resolve().parents[2] / "docs" / "guide" / "reference" / "config.md"
